...
class CI_Upload {
    ...
    function do_upload($field = 'userfile') {
        ...
        $this->file_name = isset($this->file_name) ? $this->file_name . $this->file_ext : $this->_prep_filename($_FILES[$field]['name']);
